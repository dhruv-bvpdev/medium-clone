...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <div className="flex items-center space-x-2 mb-6">
          ...
          <p className="font-extralight text-md">
            ...
            Published At {new Date(post._createdAt).toISOString()}
          </p>
        </div>
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-2 form-input mt-1 block w-full outline-none ring-yellow-500 focus:ring"
      ...
      <div className="flex flex-col p-10 my-10 max-w-2xl mx-auto md:shadow-yellow-500 md:shadow space-y-2">
